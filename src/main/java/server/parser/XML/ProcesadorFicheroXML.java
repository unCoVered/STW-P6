...
public class ProcesadorFicheroXML
{
	...
	private static void leerPrediccionDia(Element subseccion, ListaDia dias)
	{
		try
		{
			server.parser.datos.Dia dia = new server.parser.datos.Dia();
	 ...
	 * @param dia
	 */
	private static void mapProbPrecipitacion(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapCotaNieveProv(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapEstadoCielo(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapViento(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
			String[] array = new String[2];
	 ...
	 * @param dia
	 */
	private static void mapRachaMax(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapTemperatura(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapSensacionTermica(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapHumedadRelativa(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapUVMax(Element atDia, server.parser.datos.Dia dia)
	{
		try
		{

...
import server.parser.datos.Dia;
import server.parser.datos.HumedadRelativa;
import server.parser.datos.SensacionTermica;
import server.parser.datos.Temperatura;
...
public class ExtraerDiasLista
{
	...
	public static List<Dia> extraerDias(ListaDia diasPrediccion)
	{
		...
		try
		{
			for (server.parser.XML.Dia dia : diasPrediccion.getDiasPrediccion())
			{
	...
	private static Dia extraeDatosDia(server.parser.XML.Dia dia)
	{

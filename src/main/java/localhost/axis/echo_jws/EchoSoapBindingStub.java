...
public class EchoSoapBindingStub extends org.apache.axis.client.Stub implements localhost.axis.echo_jws.Echo {
    ...
    public java.lang.String echoString(java.lang.String param) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://DefaultNamespace", "echoString"));
